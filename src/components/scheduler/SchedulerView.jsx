    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-xl font-bold text-gray-800 mb-6 border-b pb-2">🚚 Logistics Settings</h2>

                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">

                    <div className="col-span-1">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Bottle Size Reference</label>
                        <select
                    ...
                    <div className="col-span-2">
                        <label className="block text-sm font-medium text-gray-700 mb-1">Target Daily Production (Cases)</label>
                        <div className="relative rounded-md shadow-sm">
                            <input
                                ...
                                className="block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 text-2xl p-2 pl-4"
                                placeholder="60000"
                            />
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 border-t pt-6">
                <div className="bg-gray-50 p-3 rounded border border-gray-200">
                    <span className="block text-xs text-gray-500 uppercase font-bold">Production Burn Rate</span>
                    <span className="block text-xl font-bold text-gray-800">
                        {Math.round(results.burnRate).toLocaleString()} cases/hr
                    </span>
                </div>
                <div className="bg-gray-50 p-3 rounded border border-gray-200">
                    <span className="block text-xs text-gray-500 uppercase font-bold">Truck Interval</span>
                ...
                <div className="bg-blue-50 p-3 rounded border border-blue-100 flex flex-col justify-center">
                    <span className="text-sm font-medium text-blue-800 uppercase">Daily Truck Requirement</span>
                    <span className="text-3xl font-bold text-blue-600">{results.requiredDailyLoads}</span>
                </div>
            </div>

            <div className="grid grid-cols-1 gap-6">
                {/* Helper Stat */}
                <div className="bg-gray-50 p-4 rounded-md flex justify-between items-center text-sm text-gray-600">
                    <span>Total Weekly Volume: <strong>{weeklyLoads.toLocaleString()} Loads</strong></span>
